...
if ($errors) {
    ...
    if(!$errors){
      ...
      try {
        ...
        $stmt -> execute(array(filter_input_data($_POST['fio']),filter_input_data($_POST['email']),filter_input_data($_POST['year']),filter_input_data($_POST['gender']),filter_input_data($_POST['bodyparts']),filter_input_data($_POST['bio'])));
